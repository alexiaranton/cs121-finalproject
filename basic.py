  ...
  def make_tokens(self):
    ...
    while self.current_char != None:
      if self.current_char in ' \t':
        ...
        self.advance()
      elif self.current_char in TUDLO:
...
class Parser:
  ...
  def statement(self):
    ...
    if self.current_tok.matches(TT_KEYWORD, 'PADAYON'):
      res.register_advancement()
      self.advance()
      return res.success(ContinueNode(pos_start, self.current_tok.pos_start.copy()))
      
    if self.current_tok.matches(TT_KEYWORD, 'PIANG'):
      res.register_advancement()
      self.advance()
  ...
  def expr(self):
    ...
    if self.current_tok.matches(TT_KEYWORD, 'BARYABOL'):
      res.register_advancement()
      self.advance()
    ...
    node = res.register(self.bin_op(self.comp_expr, ((TT_KEYWORD, 'UG'), (TT_KEYWORD, 'O'))))
  ...
  def atom(self):
    ...
    elif tok.matches(TT_KEYWORD, 'LINGAW'):
  ...
  def if_expr_b(self):
    return self.if_expr_cases('LAIN KUNG')
  ...
  def if_expr_c(self):
    ...
    if self.current_tok.matches(TT_KEYWORD, 'LAIN'):
      ...
      if self.current_tok.type == TT_NEWLINE:
        ...
        if self.current_tok.matches(TT_KEYWORD, 'HUMAN'):
          res.register_advancement()
          self.advance()
        else:
          return res.failure(InvalidSyntaxError(
  ...
  def if_expr_b_or_c(self):
    ...
    if self.current_tok.matches(TT_KEYWORD, 'LAIN KUNG'):
  ...
  def for_expr(self):
    ...
    if self.current_tok.matches(TT_KEYWORD, 'LAKANG'):
      res.register_advancement()
      self.advance()
    ...
    if self.current_tok.type == TT_NEWLINE:
      ...
      if not self.current_tok.matches(TT_KEYWORD, 'HUMAN'):
        return res.failure(InvalidSyntaxError(
          self.current_tok.pos_start, self.current_tok.pos_end,
          f"Nagdahom ug 'HUMAN'"
        ))
  ...
  def func_def(self):
    ...
    if not self.current_tok.matches(TT_KEYWORD, 'LINGAW'):
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        f"Nagdahom ug 'LINGAW'"
      ))
...
class Value:
  ...
  def copy(self):
    raise Exception('Walay gihubit nga paagi sa pagkopya')
  ...
  def subbed_by(self, other):
    if isinstance(other, Number):
      ...
      try:
        ...
        return None, RTError(
          other.pos_start, other.pos_end,
          'Ang elemento niini nga index dili matangtang sa lista tungod kay ang index wala sa mga utlanan',
          self.context
        )
    else:
      return None, Value.illegal_operation(self, other)
  ...
  def dived_by(self, other):
    if isinstance(other, Number):
      try:
        ...
        return None, RTError(
          other.pos_start, other.pos_end,
          'Ang elemento sa kini nga indeks dili makuha gikan sa lista tungod kay ang indeks wala sa mga utlanan',
          self.context
        )
    else:
      return None, Value.illegal_operation(self, other)
  ...
  def check_args(self, arg_names, args):
    ...
    if len(args) > len(arg_names):
      return res.failure(RTError(
        ...
        f"{len(args) - len(arg_names)} daghan kaayong args ang naagian {self}",
        self.context
      ))
    ...
    if len(args) < len(arg_names):
      return res.failure(RTError(
        self.pos_start, self.pos_end,
        f"{len(arg_names) - len(args)} gamay ra kaayo nga args ang gipasa {self}",
        self.context
      ))
...
class BuiltInFunction(BaseFunction):
  ...
  def execute(self, args):
    ...
    method_name = f'patyon_{self.name}'
  ...
  def no_visit_method(self, node, context):
    raise Exception(f'Walay execute_{self.name} nga pamaagi nga gihubit')
  ...
  def __repr__(self):
    return f"<built-in nga kalihokan {self.name}>"
  ...
  def execute_input_int(self, exec_ctx):
    while True:
      ...
      try:
        ...
        print(f"'{text}' kinahanglan nga usa ka integer. Usab!")
  ...
  def execute_append(self, exec_ctx):
    ...
    if not isinstance(list_, List):
      return RTResult().failure(RTError(
        self.pos_start, self.pos_end,
        "Ang unang argumento kinahanglang ilista",
        exec_ctx
      ))
  ...
  def execute_pop(self, exec_ctx):
    ...
    if not isinstance(index, Number):
      return RTResult().failure(RTError(
        self.pos_start, self.pos_end,
        "Ang ikaduha nga argumento kinahanglan nga numero",
        exec_ctx
      ))
  ...
  def execute_extend(self, exec_ctx):
    ...
    if not isinstance(listA, List):
      return RTResult().failure(RTError(
        self.pos_start, self.pos_end,
        "Ang unang argumento kinahanglan nga list",
        exec_ctx
      ))
    ...
    if not isinstance(listB, List):
      return RTResult().failure(RTError(
        self.pos_start, self.pos_end,
        "Ang ikaduha nga argumento kinahanglan nga ilista",
        exec_ctx
      ))
  ...
  def execute_len(self, exec_ctx):
    ...
    if not isinstance(list_, List):
      return RTResult().failure(RTError(
        self.pos_start, self.pos_end,
        "Ang argumento kinahanglang ilista",
        exec_ctx
      ))
  ...
  def execute_run(self, exec_ctx):
    ...
    if not isinstance(fn, String):
      return RTResult().failure(RTError(
        self.pos_start, self.pos_end,
        "Ang ikaduha nga argumento kinahanglan nga string",
        exec_ctx
      ))
    ...
    try:
      ...
      return RTResult().failure(RTError(
        self.pos_start, self.pos_end,
        f"Napakyas sa pagkarga sa script \"{fn}\"\n" + str(e),
        exec_ctx
      ))
    ...
    if error:
      return RTResult().failure(RTError(
        self.pos_start, self.pos_end,
        f"Napakyas sa paghuman sa pagpatuman sa script \"{fn}\"\n" +
        error.as_string(),
        exec_ctx
      ))
...
BuiltInFunction.print       = BuiltInFunction("patik")
BuiltInFunction.print_ret   = BuiltInFunction("patik_ret")
BuiltInFunction.input       = BuiltInFunction("ikadugang")
...
BuiltInFunction.extend      = BuiltInFunction("ihatag")
BuiltInFunction.len					= BuiltInFunction("taas")
BuiltInFunction.run					= BuiltInFunction("dagan")
...
class Interpreter:
  def visit(self, node, context):
    method_name = f'Bisitaha_{type(node).__name__}'
    method = getattr(self, method_name, self.no_visit_method)
    return method(node, context)

  def no_visit_method(self, node, context):
    raise Exception(f'Walay visit_{type(node).__name__} nga pamaagi nga gipasabot')
